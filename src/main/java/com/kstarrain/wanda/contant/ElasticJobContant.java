package com.kstarrain.wanda.contant;

public class ElasticJobContant {

	private ElasticJobContant() {
	}
	...
	public static final String EVENT_DATA_SOURCE_BEAN_NAME = "eventDataSourceBeanName";
